      ...
      <div className="container-app py-16">
        <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-gray-100">
          ...
          <div className="space-y-8 text-gray-600 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-800 mb-4">Sharing</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-800 mb-4">Security Precautions</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-800 mb-4">Data Deletion and Retention</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-800 mb-4">Grievance Officer</h2>
              <p className="mb-2">Insert Name of the Office:</p>
              <p className="mb-2">Designation:</p>
              <p className="mb-2">Insert Name and Address of the Company:</p>
            </section>
