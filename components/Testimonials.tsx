...
const row1 = testimonials.slice(0, 30)
const row2 = testimonials.slice(30)
...
const Testimonials = () => {
  return (
    <section className="py-16 sm:py-20 lg:py-28 w-full overflow-hidden">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          <span className="inline-block px-4 py-2 bg-yellow-100 text-yellow-600 rounded-full font-semibold text-xs sm:text-sm mb-3 sm:mb-4">
            Testimonials
          </span>
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800 mb-4 sm:mb-6 leading-tight px-4">
            Loved by Students<br className="hidden sm:block" />Across the CET
          </h2>
          <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed px-4">
            Hear from thousands of students who found their perfect stay with PGBee
          </p>
        </div>
      </div>
